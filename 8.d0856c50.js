...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "taro_swiper_core", function() { return Swiper$1; });
...
/* harmony import */ var _index_be61bb74_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1212);
...
function setBreakpoint() {
    var swiper = this;
    var activeIndex = swiper.activeIndex, initialized = swiper.initialized, _b = swiper.loopedSlides, loopedSlides = _b === void 0 ? 0 : _b, params = swiper.params;
...
var Virtual = {
    update: function (force) {
        var swiper = this;
        var _b = swiper.params, slidesPerView = _b.slidesPerView, slidesPerGroup = _b.slidesPerGroup, centeredSlides = _b.centeredSlides;
        var _c = swiper.params.virtual, addSlidesBefore = _c.addSlidesBefore, addSlidesAfter = _c.addSlidesAfter;
        var _d = swiper.virtual, previousFrom = _d.from, previousTo = _d.to, slides = _d.slides, previousSlidesGrid = _d.slidesGrid, renderSlide = _d.renderSlide, previousOffset = _d.offset;
        swiper.updateActiveIndex();
...
var Navigation = {
    update: function () {
        ...
        if (swiper.params.loop)
            return;
        var _b = swiper.navigation, $nextEl = _b.$nextEl, $prevEl = _b.$prevEl;
...
var Swiper$1 = /** @class */ (function () {
    function Swiper$1(hostRef) {
        ...
        this.onAnimationFinish = Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* c */ "d"])(this, "animationfinish", 7);
    }
    ...
    Swiper$1.prototype.componentDidLoad = function () {
        var _a;
        var _b = this, autoplay = _b.autoplay, current = _b.current, interval = _b.interval, duration = _b.duration, circular = _b.circular, vertical = _b.vertical, displayMultipleItems = _b.displayMultipleItems;
        ...
        var previousMargin = /^(\d+)px/.exec(this.previousMargin);
        if (((_a = previousMargin) === null || _a === void 0 ? void 0 : _a.length) && !isNaN(parseInt(previousMargin[1]))) {
        ...
        this.swiper = new Swiper(".taro-swiper-" + this._id, options);
    };
    Swiper$1.prototype.render = function () {
        var _b = this, indicatorDots = _b.indicatorDots, indicatorColor = _b.indicatorColor, indicatorActiveColor = _b.indicatorActiveColor;
        var cls = Object(_index_be61bb74_js__WEBPACK_IMPORTED_MODULE_1__[/* c */ "a"])("taro-swiper-" + this._id, 'swiper-container');
        var paginationCls = Object(_index_be61bb74_js__WEBPACK_IMPORTED_MODULE_1__[/* c */ "a"])('swiper-pagination', {
        ...
        return (Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* H */ "a"], { style: hostStyle }, Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])("div", { class: cls, style: style }, Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])("style", { type: 'text/css' }, "\n              .taro-swiper-" + this._id + " .swiper-pagination-bullet { background: " + indicatorColor + " }\n              .taro-swiper-" + this._id + " .swiper-pagination-bullet-active { background: " + indicatorActiveColor + " }\n            "), Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])("div", { class: 'swiper-wrapper' }, Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])("slot", null)), Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])("div", { class: paginationCls }))));
    };
...
var SwiperItem = /** @class */ (function () {
    ...
    SwiperItem.prototype.render = function () {
        return (Object(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* h */ "f"])(_core_42efd82a_js__WEBPACK_IMPORTED_MODULE_0__[/* H */ "a"], { class: 'swiper-slide', "item-id": this.itemId }));
    };
    return SwiperItem;
}());
